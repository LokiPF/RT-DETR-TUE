...
python tools/infer_rtdetrv2_predictive_uncertainty.py \
  -c configs/rtdetrv2/rtdetrv2_r18vd_120e_coco_tue.yml \
  -r output/rtdetrv2_r18vd_120e_coco/best.pth \
  --tu-prototypes output/tu/bbox_prototypes.pth \
  --input dataset/000000581738.jpg \
  --output-dir output/tu/learned_visualizations \
  --confidence-threshold 0.5 \
  --tu-topk 50 \
  --coverage 0.95 \
  --coverage-kind coordinate \
  --save-json